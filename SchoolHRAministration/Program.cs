...
namespace SchoolHRAministration
{
    ...
    class Program
    {
        ...
        public static void SeedData(List<IEmployee> employees)
        {
            ...
            IEmployee headOfDepartament = EmployeeFactory.GetEmployeeInstance(EmployeeType.HeadOfDepartament, 3, "Brenda", "Mullins", 50000);
        ...
        public static IEmployee GetEmployeeInstance(EmployeeType employeeType, int id, string firstName, string lastName, decimal salary)
        {
            ...
            switch (employeeType)
            {
                ...
                case EmployeeType.HeadOfDepartament:
                    employee = FactoryPattern<IEmployee, HeadOfDepartament>.GetInstance();
                    break;
